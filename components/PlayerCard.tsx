...
export default function PlayerCard({ infos, onClick }) {
    console.log(infos);
    return (
        <div className={styles.container} onClick={onClick}>
            <img className={styles.picture} src={infos.picture} />
            <p className={styles.name}>{infos.firstname} {infos.lastname}</p>
            <div className={styles['attribute-container']}>
                ...
                <p className={styles['attribute-value']}>{infos.country.code}</p>
            </div>
        </div>
    );
}
